  ...
  return knex("weapons")
    ...
    .then(() => {
      ...
      return knex("weapons").insert([
        ...
        { id: 3, label: "Loup",     speed: 10, atk: 90, def: -5 },
        { id: 4, label: "Ours",   speed: 5, atk: 90, def: 0 },
        { id: 5, label: "Rhinocéros", speed: -10, atk: 90, def: 20 },
      ]);
    })
    .then(() => {
    ...
    .then(() => {
      ...
      return knex("gladiators").insert([
        ...
        { id: 5, first_name: 'Rex', last_name: 'Gros croc', birthdate: moment("12/12/1978", "DD/MM/YYYY").toDate(), gladiator_type_id: 2, ludi_id: 1},
        ...
        { id: 8, first_name: 'Cerf', last_name: 'Bambi', birthdate: moment("12/12/1978", "DD/MM/YYYY").toDate(), gladiator_type_id: 3, ludi_id: 1},
        { id: 9, first_name: 'Ronan', last_name: 'Dikoto', birthdate: moment("12/12/1978", "DD/MM/YYYY").toDate(), gladiator_type_id: 4, ludi_id: 1},
        { id: 10, first_name: 'Animal', last_name: 'sauvage', birthdate: moment("12/12/1978", "DD/MM/YYYY").toDate(), gladiator_type_id: 5, ludi_id: 1}
      ]);
    });
};
